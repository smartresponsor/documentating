...
_Source asciidoc: `docs/article/zz-spacex-confidential-ipo-return-of-the-mega-listing.adoc`_
image::spacex-mega-ipo-scale.svg[Mega IPO as a market-depth test,align=center,width=100%]

[.text-center]
_Editorial illustration: a schematic view of why a mega-listing can test market depth rather than simply add one more ticker to the calendar._
...
[.text-center]
image::spacex-infrastructure-stack.svg[SpaceX as an infrastructure-capital narrative,align=center,width=100%]

[.text-center]
_Editorial illustration: SpaceX as a layered infrastructure story rather than a single-category issuer._
...
* Visuals are local editorial schematics stored in the shared assets pool.
* The page no longer depends on external hotlinked images for publication stability.
