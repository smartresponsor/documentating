...
_Source asciidoc: `docs/article/spacex-confidential-ipo-return-of-the-mega-listing.adoc`_
image::https://commons.wikimedia.org/wiki/Special:FilePath/Falcon_9_launch.jpg[SpaceX launch,align=center,width=900]
...
image::https://commons.wikimedia.org/wiki/Special:FilePath/Wall_Street_-_New_York_Stock_Exchange.jpg[Wall Street and the New York Stock Exchange,align=center,width=900]
...
* Embedded images use direct Wikimedia upload URLs and should be reviewed for your repository’s image-hosting policy.
