...
:page-slug: the-first-great-war-between-platforms-and-protocols
:page-published: 2026-03-29
:page-author: Oleksandr
:description: A long-form article on the structural conflict between closed platforms and open agent-mediated commerce protocols.
:page-tags: ai, ecommerce, protocols, platforms, agentic-commerce, amazon

_Source asciidoc: `docs/article/the-first-great-war-between-platforms-and-protocols.adoc`_
...
If a human shopper comes to Amazon directly, Amazon gets to shape the journey:

* what appears first,
* what gets sponsored placement,
* what gets bundled,
* what gets cross-sold,
* what gets seen,
* what gets ignored.
...
Perplexity argued that Amazon was trying to block a model in which users choose their own AI layer and, in Perplexity’s words, AI agents do not have eyeballs for Amazon’s pervasive advertising. That line matters because it accidentally explains the whole conflict.
