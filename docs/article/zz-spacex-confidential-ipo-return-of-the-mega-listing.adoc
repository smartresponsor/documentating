...
image::/assets/spacex-mega-ipo-scale.svg[Mega IPO as a market-depth test,align=center,width=100%]
...
[.text-center]
image::/assets/spacex-infrastructure-stack.svg[SpaceX as an infrastructure-capital narrative,align=center,width=100%]
